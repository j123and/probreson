...
class Dashboard:
    ...
    def __init__(self, ROOM_HEIGHT, ROOM_WIDTH, UniformF, T_MINUS_K):
        ...
        self.input_widgets2 = widgets.HBox([widgets.VBox([widgets.Text('SensorModel UF - NUF'), self.slider_f]), widgets.VBox([widgets.Text('Smoothing window length, 0 = filtering'), self.slider_windowL])])
